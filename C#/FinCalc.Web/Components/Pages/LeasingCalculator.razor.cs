...
public partial class LeasingCalculator
{
    ...
    private LeasingCalculationRequest Request { get; } = new LeasingCalculationRequest();

    private LeasingCalculationResult? Result { get; set; }
    ...
    private void OnCalculate()
    {
        ...
        Result = (LeasingCalculationResult)result;
    }
